...
namespace EducationApp.Web.Areas.Admin.Controllers
{
    ...
    public class TeacherController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var teachers = await _teacherService.GetAllTeachersWithCategory();
        ...
        public async Task<IActionResult> Edit(int id)
        {
            ...
            var teacher = await _teacherService.GetTeacherWithCategories(id);
        ...
        [HttpPost]
        public async Task<IActionResult> Edit(TeacherUpdateDto teacherUpdateDto, int[] selectedCategoryIds)
        {
            if (ModelState.IsValid)
            {
                var teacher = await _teacherService.GetByIdAsync(teacherUpdateDto.Id);
                if (teacher == null)
                {
                    return NotFound();
                }
                ...
                teacher.City = teacherUpdateDto.City;
            ...
            teacherUpdateDto.Categories = categories;
