    ...
    public class KitabeviContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Kitap>()
                .HasData(
                    new Kitap() {AnaSayfa=true, Id = 1, Ad = "İnsanlar", BasimYili = 2021, SayfaSayisi = 330, KategoriId = 2, YazarId = 1, Ozet="Lorem ipsum dolor sit amet consectetur, adipisicing elit. Dolor vel repellat fugit, neque cupiditate natus molestiae aliquid. Aliquid officiis hic error aliquam, deleniti neque explicabo, illum, modi commodi eos obcaecati." },
                    ...
                    new Kitap() { Id = 5, Ad = "Serenad", BasimYili = 2020, SayfaSayisi = 300, KategoriId = 2, YazarId = 9 , Ozet="Lorem ipsum dolor sit amet consectetur, adipisicing elit. Dolor vel repellat fugit, neque cupiditate natus molestiae aliquid. Aliquid officiis hic error aliquam, deleniti neque explicabo, illum, modi commodi eos obcaecati."},
                    new Kitap() { Id = 6, Ad = "19", BasimYili = 2016, SayfaSayisi = 380, KategoriId = 2, YazarId = 6 , Ozet="Lorem ipsum dolor sit amet consectetur, adipisicing elit. Dolor vel repellat fugit, neque cupiditate natus molestiae aliquid. Aliquid officiis hic error aliquam, deleniti neque explicabo, illum, modi commodi eos obcaecati."},
