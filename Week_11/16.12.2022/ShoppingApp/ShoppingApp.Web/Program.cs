...
//appsettings dosyasýndan Connection string çekmiþ olduk.Güvenlik açýsýndan önemli.ShopAppContextten Onconfiguring metodunu kapattýk.
...
builder.Services.AddScoped<IEmailSender, SmtpEmailSender>(x => new SmtpEmailSender(
    builder.Configuration["EmailSender:Host"], //appsettings içinde
    builder.Configuration.GetValue<int>("EmailSender:Port"),//appsettings içinde string türünde olmayanlar alrken GetValue ile çevirmemiz gerekiyor
