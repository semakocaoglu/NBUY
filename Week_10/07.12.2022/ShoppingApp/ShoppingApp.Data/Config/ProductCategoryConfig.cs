...
namespace ShoppingApp.Data.Config
{
    public class ProductCategoryConfig : IEntityTypeConfiguration<ProductCategory>
    {
        public void Configure(EntityTypeBuilder<ProductCategory> builder)
        {
            ...
            //Burada productId ve categoryId'den oluşan her bir satırın bir kez daha tekrar etmemesi için bir Composite Primary Key tanımlaması yaptık.
            builder.ToTable("ProductCategories");
            builder.HasData(
                new ProductCategory {ProductId =1, CategoryId=1 },
                new ProductCategory { ProductId = 1, CategoryId = 2 },//1 numaralı ürünün hem telefon hem de elektronik kategorisinden olduğunu söyler.
