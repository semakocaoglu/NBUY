        ...
        public void Configure(EntityTypeBuilder<Product> builder)
        {
            ...
            builder.Property(p => p.DateAdded)
                .HasDefaultValueSql("date('now')");  //Sqlite
                                                     //.HasDefaultValueSql("getdate()"); (Bu SqlServer ile çalışırken kullanma şeklimiz)
            ...
            builder.HasData(
                ...
                new Product { Id=3, Name= "Iphone 13", Price=21500, 
                    ...
                    Url= "iphone-13", IsHome=true, IsApproved=true},

                new Product { Id=4, Name="Iphone 14 Pro", Price=34500, 
                    Description= "Kamerası son teknoloj", ImageUrl="4.png",
                    Url="iphone-14-pro", IsHome=false, IsApproved=true},

                new Product { Id=5, Name="Ipad 12", Price=24500, 
                ...
                new Product { Id=8, Name="Arçelik Türk Kahvesi Makinesi TK8", Price=24500, 
                    ...
                    Url="arçelik-turk-kahvesi-makinesi-tk8", IsHome=true, IsApproved=true},
                ...
                new Product { Id=12, Name="Samsung NF34/Buzdolabı", Price=13000, 
                    ...
                    Url="samsung-nf-34-buzdolabi", IsHome=false, IsApproved=true}
