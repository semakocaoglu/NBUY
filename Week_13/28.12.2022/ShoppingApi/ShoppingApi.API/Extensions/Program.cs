...
builder.Services.AddControllers(); //MVC yapısı gibi değil sadece controllerim var.

builder.Services.AddEndpointsApiExplorer(); //Api'nın rota yapısını oluşturmaya yarar.
