...
namespace ShoppinApi.Data.Migrations
{
    /// <inheritdoc />
    public partial class Intitiy : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "ac40dccd-1f68-40b3-99a5-3560ad913b5c", null, "Admin rolü", "Admin", "ADMIN" },
                    { "b931d3f4-61da-42fb-86fe-9d22f75da1b7", null, "User rolü", "User", "USER" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "20aa186a-cdbe-4eb4-85ff-73388e16f9c2", 0, "Akasya cd. Orkide sk. Gül ap.", "İzmir", "d2afc867-40be-4e60-9fe5-1c1b12a2fb12", new DateTime(1985, 10, 29, 0, 0, 0, 0, DateTimeKind.Unspecified), "user@gmail.com", true, "Kemal", "Erkek", "User", false, null, "USER@GMAIL.COM", "USER", "AQAAAAIAAYagAAAAEC/vTW7SJaVydAQrjpVdHTwwKgiMBkZNUY47y86IOUI0CG6Ytd5R8vUL9uOyqF3NHg==", "4444444444", false, "b4bbfabd-19cd-4a13-b573-1345b423ce70", false, "user" },
                    { "351b118d-b3f6-43f3-9cf7-0bd7a4700060", 0, "Çek cd. Senet sk. Fatura ap.", "İstanbul", "04d7b64d-ac95-45d7-a45c-ca2abd1624ea", new DateTime(1998, 5, 19, 0, 0, 0, 0, DateTimeKind.Unspecified), "admin@gmail.com", true, "Deniz", "Kadın", "Admin", false, null, "ADMIN@GMAIL.COM", "ADMIN", "AQAAAAIAAYagAAAAEF/BwBk8KUi5tV23u3EEGcZxVjn4oxq5T+RKGFCFqxWtnOysLWacrG5GtxtkQDzMiw==", "5555555555", false, "4c72734a-19d5-4214-9238-21ae689283a0", false, "admin" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "b931d3f4-61da-42fb-86fe-9d22f75da1b7", "20aa186a-cdbe-4eb4-85ff-73388e16f9c2" },
                    { "ac40dccd-1f68-40b3-99a5-3560ad913b5c", "351b118d-b3f6-43f3-9cf7-0bd7a4700060" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "351b118d-b3f6-43f3-9cf7-0bd7a4700060" },
                    { 2, "20aa186a-cdbe-4eb4-85ff-73388e16f9c2" }
                });
