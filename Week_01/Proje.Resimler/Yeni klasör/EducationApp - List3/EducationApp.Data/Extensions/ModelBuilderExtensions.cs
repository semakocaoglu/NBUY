            ...
            List<Student> students = new List<Student>
                {
                    ...
                    new Student { Id = 2, UserId = users[2].Id, FirstName = "Ahmet", LastName = "Akyılmaz", Age = 25, Gender = "Erkek", ImageUrl = "2.png", Url = "ahmet-akyilmaz", City = "İzmir", Description = "Tenis öğrenmek istiyorum.", LessonPlace = "Yüz Yüze" },
                     ...
                     new Student { Id = 3, UserId = users[3].Id, FirstName = "Ayşe", LastName = "Candan", Age = 16, Gender = "Kadın", ImageUrl = "3.png", Url = "ayse-candan", City = "Ankara", Description = "Merhaba, ben Ayşe Candan. Lise öğrencisiyim. Matematik derslerime yardımcı bir öğretmen arıyorum", LessonPlace = "Online" },

                     new Student { Id = 4, UserId = users[4].Id, FirstName = "Merve", LastName = "Akman", Age = 18, Gender = "Kadın", ImageUrl = "4.png", Url = "merve-akman",  City = "Bursa", Description = "Merhaba, ben Merve Akman. Fizik derslerinde bana yardımcı olabilecek bir öğretmen arıyorum", LessonPlace = "Online" },


                      new Student { Id = 5, UserId = users[5].Id, FirstName = "Ali", LastName = "Kara", Age = 22, Gender = "Erkek", ImageUrl = "5.png", Url = "ali-kara", City = "İstanbul", Description = "Merhaba, ben Ali Kara. İngilizce derslerinde bana yardımcı olabilecek bir öğretmen arıyorum.", LessonPlace = "Online" },

                      new Student { Id = 6, UserId = users[6].Id, FirstName = "Ayşe", LastName = "Sağlam", Age = 35, Gender = "Kadın", ImageUrl = "6.png", Url = "ayse-saglam", City = "İzmir", Description = "Merhaba, ben Ayşe Sağlam. Çeşitli dans dersleri almak istiyorum. Aynı zamanda müzik alanına da çok ilgiliyim, bu sebepten piyano dersleri almak için de bir hoca arıyorum.", LessonPlace = "Yüz yüze" },

                      new Student { Id = 7,  UserId = users[7].Id, FirstName = "Ahmet", LastName = "Ak", Age = 17, Gender = "Erkek", ImageUrl = "7.png", Url = "ahmet-ak", City = "Adana", Description = "Merhaba, ben Ahmet Ak. Matematik ve Fizik alanlarında bana sınava hazırlık sürecinde yardımcı olacak hocalardan ders almak istiyorum.", LessonPlace = "Online" },


                      new Student { Id = 8, UserId = users[8].Id, FirstName = "Beyza", LastName = "Güven", Age = 20, Gender = "Kadın", ImageUrl = "8.png", Url = "beyza-guven", City = "İstanbul", Description = "Merhaba, ben Beyza Güven. Mühendislik öğrencisiyim ve AutoCad eğitimi almak istiyorum. Bana bu konuda yardımcı olabilecek eğitmenlerle iletişime geçmek istiyorum.", LessonPlace = "Online" }
            };
