...
namespace BlogApp.Data.Concrete.EntityFramework.Mappings
{
    public class ArticleMap : IEntityTypeConfiguration<Article>
    {
        ...
        {
            #region
            //Burada EF Core tarafından default convention yöntemiyle kendiliğinden gerçekleşen bazı yönetemleri el ile yapmış olacağz. Bu daha profesyonel, sürdürülebilir,genişletilebilir uygulamalar yapmak için kullanılır.

            #endregion
            builder.HasKey(a => a.Id); //PrimaryKey
            builder.Property(a=>a.Id).ValueGeneratedOnAdd(); //Id eklendikçe birer birer artış
            ...
            //İlk Article verileirnin eklenmmesi
            builder.HasData(
                new Article
                {
                    Id = 1,
