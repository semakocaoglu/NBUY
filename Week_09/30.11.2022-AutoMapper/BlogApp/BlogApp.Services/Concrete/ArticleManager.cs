...
namespace BlogApp.Services.Concrete
{
    public class ArticleManager : IArticleService
    {
        ...
        public async Task<IResult> Add(ArticleAddDto articleAddDto, string createdByName)
        {
            ...
            article.UserId = 1;
            #region
            //UserId' yi şimdilik elle veriyoruz. Login işlemlerini tamaladığımzda burayı değiştiriyor olacağız.
            //Eğer entity base içinde CreatedDate için default değer vermemiş olsadık, böyle yapabilirdik.Bunun ikinci bir yolu da, profile içinden bu değeri vermektir.
