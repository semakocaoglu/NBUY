...
namespace BlogApp.Services.Concrete
{
    public class ArticleManager : IArticleService
    {
        ...
        public async Task<IDataResult<ArticleDto>> Add(ArticleAddDto articleAddDto, string createdByName)
        {
            ...
            article.UserId = 1;
            #region Açıklamalar
            //UserId'yi şidilik elle veriyoruz. Login işlemlerini gerçeklerştirdiğimizde burayı değiştiricez.
            //Eğer entitybase içerisinde createddatedate için default değer vermemiş olsaydık böyle yapabilirdik
            //Bunun ikinci bir yolu da profile içinden bu değeri vermektir.
